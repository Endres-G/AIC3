...
class EditPaymentMethodView extends GetView<HomeController> {
  const EditPaymentMethodView({super.key});
            ...
            child: Column(
              ...
              children: [
                ...
                const Padding(
                  ...
                  child: Text(
                    "Edite seus métodos de pagamento",
                    style: TextStyle(
                    ...
                    children: controller.paymentMethods.map((method) {
                      return CheckboxListTile(
                        title: Text(
                          ...
                          style: TextStyle(
                            color: controller.selectedPaymentMethods
                                    .contains(method['id'])
                        ...
                        value: controller.selectedPaymentMethods
                            .contains(method['id']),
                        onChanged: (_) {
                          controller.togglePaymentMethod(method['id'] as int);
                        },
